namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        private void ViewPost()
        {
            ...
            var post = PostService.GetPostsByCategory(categoryId).ToArray();
            var postIndex = categoryController.CurrentPage *
                CategoriesController.PAGE_OFFSET +
                currentOptionIndex;
            var postId = post[postIndex - 1].Id;
        ...
        private void AddPost()
        {
            ...
            var postViewer = (PostDetailsController)
                this.controllers[(int)MenuState.ViewPost];
