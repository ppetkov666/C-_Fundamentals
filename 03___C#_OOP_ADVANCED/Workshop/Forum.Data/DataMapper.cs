    ...
    class DataMapper
    {
        ...
        public static void SafeCategories(List<Category> categories)
        {
            ...
            foreach (var category in categories)
            {
                ...
                string line = string
                    .Format(categoryFormat, category.Id, category.Name,
        ...
        public static void SafeUsers(List<User> users)
        {
            ...
            foreach (var user in users)
            {
                ...
                string line = string
                    .Format(userFormat, user.Id, user.Username,user.Password,
        ...
        public static void SafePosts(List<Post> posts)
        {
            ...
            foreach (var post in posts)
            {
                ...
                string line = string
                    .Format(postFormat, post.Id, post.Title, post.Content, post.CategoryId
        ...
        public static void SafeReplies(List<Reply> replies)
        {
            ...
            foreach (var reply in replies)
            {
                ...
                string line = string
                    .Format(replyFormat, reply.Id, reply.Content, reply.AuthorId, reply.PostId);
                lines.Add(line);
            }
